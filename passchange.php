...
<html>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	<body background="homepic.jpg">
		...
		<form method= "post" action="changepass1.php" style="border-style:double;border-width:5";><center>
			<br/>
			Student Id:<br/>
			<input type="text" placeholder="Student Id" name="id" style="width:250;border: 2px solid red;
    border-radius: 4px"; required></br></br>
			Name:<br/>
			<input type="text" placeholder="Name" name="name" style="width:250;border: 2px solid red;
    border-radius: 4px"; required></br></br>
			Class:<br/>
			<input type="text" placeholder="Class" name="class" style="width:250;border: 2px solid red;
    border-radius: 4px"; required></br></br>
			Phone:<br/>
			<input type="text" placeholder="Phone" name="phone" style="width:250;border: 2px solid red;
    border-radius: 4px"; required></br></br>
			New Password:<br/>
			<input type="password" placeholder="New Password" name="newpass" style="width:250;border: 2px solid red;
    border-radius: 4px"; required></br></br>
			<br/>
