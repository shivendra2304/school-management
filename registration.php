<html>
	...
	<body background="homepic.jpg">
		...
		<body>
			<form method= "post" action="reg.php" style="border-style:double;border-width:5";><center>
			<br/><br/>
			Name:<br/>
    ...
    border-radius: 4px"; required></br></br>
			Address:<br/>
			<input type="text" placeholder="Address" name="add" style="width:250;border: 2px solid red;
    border-radius: 4px"; required></br></br>
			Phone:<br/>
			<input type="text" placeholder="Phone" name="phone" style="width:250;border: 2px solid red;
    border-radius: 4px"; required></br></br>
			Master Password:<br/>
			<input type="password" placeholder="Master Password" name="teacherpass" style="width:250;border: 2px solid red;
    border-radius: 4px"; required></br></br>
			<br/>
